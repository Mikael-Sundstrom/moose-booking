...
<div class="wrap">
    ...
    <div style="display: flex; gap: 20px; margin-top: 20px;">
        <div style="background: #fff; border: 1px solid #ccd0d4; padding: 20px; flex: 1; text-align: center;">
            ...
            <p><strong><?php echo esc_html('0'); // Här kommer antal formulär ?></strong></p>
        </div>
        <div style="background: #fff; border: 1px solid #ccd0d4; padding: 20px; flex: 1; text-align: center;">
            <h3><?php esc_html_e('Totalt antal bokningar', 'moose-booking'); ?></h3>
            <p><strong><?php echo esc_html('0'); // Här kommer antal bokningar ?></strong></p>
        </div>
        <div style="background: #fff; border: 1px solid #ccd0d4; padding: 20px; flex: 1; text-align: center;">
            <h3><?php esc_html_e('SMS-kassa', 'moose-booking'); ?></h3>
            <p><strong><?php echo esc_html('0'); // Här kommer antal bokningar ?> kr</strong></p>
        </div>
    </div>
